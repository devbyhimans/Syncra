    ...
    return (
        <div className="space-y-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-4">
                ...
                <select value={filters.priority} onChange={(e) => setFilters({ ...filters, priority: e.target.value })} className="px-3 py-2 rounded-lg border border-gray-300 dark:border-zinc-700 text-gray-900 dark:text-white text-sm  dark:bg-gray-950" >
