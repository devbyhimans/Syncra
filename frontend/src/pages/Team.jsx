        ...
        <div className="space-y-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-wrap gap-4">
                ...
                <div className="group relative overflow-hidden rounded-3xl p-6 transition-all flex-1 min-w-[250px] bg-white border border-zinc-200 hover:border-zinc-300 dark:bg-neutral-900 dark:border-white/10 dark:hover:border-white/20">
                    ...
                    <div className="relative z-10 flex items-center justify-between gap-8 md:gap-22">
                        <div>
                            ...
                            <p className="mt-2 text-xl font-bold text-gray-900 dark:text-white">{users.length}</p>
                        </div>
                        <div className="p-3 rounded-xl bg-blue-100 dark:bg-blue-500/10">
                            <UsersIcon className="size-5 text-blue-500 dark:text-blue-200" />
                        </div>
                    </div>
                </div>
                ...
                <div className="group relative overflow-hidden rounded-3xl p-6 transition-all flex-1 min-w-[250px] bg-white border border-zinc-200 hover:border-zinc-300 dark:bg-neutral-900 dark:border-white/10 dark:hover:border-white/20">
                    ...
                    <div className="relative z-10 flex items-center justify-between gap-8 md:gap-22">
                        <div>
                            <p className="text-sm font-medium text-gray-500 dark:text-zinc-400">Active Projects</p>
                        ...
                        <div className="p-3 rounded-xl bg-emerald-100 dark:bg-emerald-500/10">
                            <Activity className="size-5 text-emerald-500 dark:text-emerald-200" />
                        </div>
                    </div>
                </div>
                ...
                <div className="group relative overflow-hidden rounded-3xl p-6 transition-all flex-1 min-w-[250px] bg-white border border-zinc-200 hover:border-zinc-300 dark:bg-neutral-900 dark:border-white/10 dark:hover:border-white/20">
                    ...
                    <div className="relative z-10 flex items-center justify-between gap-8 md:gap-22">
                        <div>
                            ...
                            <p className="mt-2 text-xl font-bold text-gray-900 dark:text-white">{tasks.length}</p>
                        </div>
                        <div className="p-3 rounded-xl bg-purple-100 dark:bg-purple-500/10">
                            <Shield className="size-5 text-purple-500 dark:text-purple-200" />
                        </div>
                    </div>
                </div>
            </div>
